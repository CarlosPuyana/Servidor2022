	...
	<div class="container mt-5">
		...
		<div class="row justify-content-center mt-5">
			...
			<c:if test="${sessionScope.usuario != null}">
				...
				<img alt="Error" src="https://hips.hearstapps.com/hmg-prod.s3.amazonaws.com/images/02-chiron-sport-legendes-du-ciel-1606231462.jpg" style="width: 500px; height: 500px">
